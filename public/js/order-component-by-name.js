$(document).ready(function () {
    ...
    function createProductModal(product, index) {
        ...
        productModal += `<img src="${product.image_path ? product_BIU + '/' + product.image_path : ASSET_URL + 'images/no-image-available.jpg'}" class="img-fluid" />`;
        productModal += `</div>`;
    ...
    function createProductCard(product, index) {
        ...
        productCard += `<figure><img class="product-image px-0" src="${product.image_path ? product_BIU + '/' + product.image_path : ASSET_URL + 'images/no-image-available.jpg'}" alt="Card image cap"></figure>`;
        productCard += `</div>`;
        productCard += `<div class="col-lg-6">`;
