...
@section('content')
                ...
                <div class="col-lg-12 col-12 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="mb-20">
                            ...
                            <p>Enhance the style and functionality of your kitchen with our premium accessories. From smart storage solutions to innovative accessories, everything is designed to combine modern convenience with timeless elegance.</p>
                        </div>
    ...
    <!-- SHOP SECTION START -->
    <div class="ltn__product-area ltn__product-gutter mb-120 mt-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                            ...
                            <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                ...
                                <div class="product-info">
                                    ...
                                    <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                                        ...
                                        <li class="bg-light p-2">{{$product->height}}</li>
                                        @endif
                                        <li>
                                    ...
                                    <div class="product-hover-action">
                                        ...
                                        <button class="btn btn-warning p-2 w-100 mt-2">Add to Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
