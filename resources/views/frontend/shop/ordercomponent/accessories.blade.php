...
<div class="container">
    <div class="row my-5">
            <div class="col-12">
                ...
                <img class="img-fluid w-100 d-md-none rounded shadow-lg" src="{{ asset('imgs/categories/'.$category->mobile_image_path) }}" alt="">
                                            ...
                                            <div class="accordion-body px-0 py-0 pb-1">
                                                <div class="ps-2">
                                                    <div class="row g-1" id="heights-filter">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-check form-check-inline">
                                                                <input data-heights-id="{{$height->id}}" class="form-check-input height-filter" type="checkbox"
