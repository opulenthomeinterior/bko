    ...
    <div class="container py-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4 my-3">
                <div class="card">
                    <img src="{{ $style->image_path ? asset('imgs/products/' . \App\Models\Product::where('style_id', $style->id)->first()->image_path) : '#' }}" class="card-img-top" style="max-height: 400px" id="main-image" alt="Kitchen Cabinet">
