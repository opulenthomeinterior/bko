<x-guest-layout>
    <head>
        @section('meta_tags')
        <title>Kitchen Door Replacement | Kitchen Cabinet & Cabinet Doors </title>
        ...
        <script type="application/ld+json">
            ...
            "description": "Buy Kitchen Online is here to upgrade your space with kitchen Cabinet doors & cabinet doors replacement by changing your kitchen unit doors in London (North London, North East London, Central London & East London).",
        ...
        .hero {
            ...
            background: url('{{ asset('images/cabinets-bg.png') }}') center/cover no-repeat;
...
<body>
            ...
            <div class=" col-xl-8 col-12 align-self-center px-5 d-flex flex-column flex-md-row p-0">
                <div class="row">
                    ...
                    <div class="align-self-center rounded shadow-lg order-sample position-relative col-12 col-xl-8 bg-white rounded-lg border-0 shadow-sm" style="">
                        ...
                        --}}
                        <a href="{{ route('ordercomponentbytypename', 'doors') }}" class="btn bg-orange px-1 fw-bold text-uppercase rounded-0 " style="font-size:14px;">  Order a Sample of your choice NOW!</a>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 rounded">
                 <img class="img-fluid d-none d-sm-block" src="{{ asset('images/tired-of-outdated-cabinets.png') }}"/>
                 <img class="img-fluid d-sm-none" src="{{ asset('images/tired-of-outdated-cabinets-mobile.png') }}"/>
                ...
                <div class="col-12 col-lg-4 my-3">
                    ...
                    <div class="product-card">
                       ...
                       <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/J-pull-Dove-Grey1744357344_67f8c7e02f610.png" class="product-image" id="main-image" alt="Kitchen Cabinet"></a>
                       </div>
                        @elseif($style->id == 2)
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Belsay-Cashmere1744359926_67f8d1f695086.jpg" class="product-image"  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 3)
                       ...
                       <div class="product-image-container">
                       <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Vivo-Gloss-Dust-Grey-Door-Flat_CMYK_PRINT1720430622_668bb01e6686d.jpg" class="product-image"  id="main-image" alt="Kitchen Cabinet"></a>
                       </div>
                        @elseif($style->id == 4)
                        ...
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/vivo_vero_matt_anthracite1744270130_67f773321d81e.png" class="" id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 5)
                        ...
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Lucente-Gloss-Dust-Grey-Door-Perspective_CMYK_PRINT1720441467_668bda7b578b1.jpg" class=""  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 6)
                        ...
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Cartmel-Anthracite-Flat-Door-Cutout_RGB_Web1720451119_668c002f56976.jpg" class=""  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 7)
                        ...
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Vivo-Matt_Cashmere_Door-Flat_With-Handle1720432485_668bb765d85c3.jpg" class=""  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 8)
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/vivo_vero_matt_light_grey1744270102_67f77316cd6eb.png" class=""  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 9)
                        <div class="product-image-container">
                        <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}"><img src="https://bkonline.uk/public/imgs/products/Matt-Light-Grey-Door-with-Handle1730581810_67269532decf5.jpg" class=""  id="main-image" alt="Kitchen Cabinet"></a>
                        </div>
                        @elseif($style->id == 10)
                        ...
                        {{-- <div class="card-body text-center"> --}}
                            ...
                            <div class="color-grid">
                                ...
                                <a href="{{ route('ordercomponentbytypename', ['doors']) }}?style_id={{$style->id}}&colour_id={{$styleColour}}" title="{{ $colour->trade_colour }}">
    ...
    <div class="container-fluid py-3" style="background-color:#f2f4f5">
        <div class="container py-5">
            ...
            <p class="benefit-text mb-2 mt-5 fs-4">Benefit from our limited time offer and <br><span class="text-black">Get a Free Quote for Cabinet Door Replacement</span></p>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-1 text-center text-black mb-2 text-uppercase"> kitchen Cabinet DOOR REPLACEMENT</h1>
...
{{-- <div class ="container-fluid bg-white">
    ...
    <div class ="container-fluid bg-white">
        <section class="consultation-section bg-white">
            <div class="container bg-white">
                <h2 class="mb-2 text-black text-uppercase">Why Choose Buy Kitchen Online for <br> Cabinet Door Replacement?</h2>
                <div class = "row mb-1 justify-content-center">
                    <div class="col-6">
                        <div id="lines" class="mb-3">
                            <div id="line1"></div>
            ...
            <div class="faq-list">
                {{-- @if (!empty($home)) --}}
                     ...
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                ...
                                What is meant by kitchen Cabinet door replacement?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                       <p>Kitchen Cabinet door replacement gives your kitchen a new look by replacing the Cabinet doors without a complete renovation.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                ...
                                Why is it better to replace just the Cabinet doors instead of a whole kitchen remodel?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                       <p>Replacing kitchen Cabinet doors is affordable, faster, and causes less disruption than a full kitchen remodel.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                ...
                                Will my existing kitchen layout get disturbed by the new Cabinet doors?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                       <p>Not at all, as the new kitchen Cabinet doors will be customized to your kitchen style and measured according to your current kitchen layout.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                        ...
                        <div class="faq-answer">
                       <p>Typically, installation takes 2-3 days after the Cabinet doors are manufactured and ready.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                What if I go for a change of style or colour of my Cabinet doors?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                     ...
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                Can you replace the old wooden doors or laminate Cabinet doors?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                       <p>Yes, we can replace any old, outdated kitchen Cabinet doors with new ones, enhancing the outlook of your kitchen.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                            <div>
                                Will the new doors fit my existing Cabinets?
                            </div>
                            <i class="fas fa-chevron-down"></i>
                        </div>
                        <div class="faq-answer">
                       <p>Yes, the new door's dimensions will match your existing Cabinets.</p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        <div class="faq-question">
                       ...
                       <p>
                        ...
                        Yes, we offer Shaker kitchen Cabinets, giving your kitchen a classic-traditional look.
                        </p>
                        </div>
                    </div>
                     <div class="faq-item" data-category="general">
                        ...
                        <div class="faq-answer">
                       <p>
                        Absolutely, we can change the knobs, handles and hinges if you'd like to update them along with the kitchen Cabinet doors.
                        </p>
                        </div>
                    </div>
