<x-guest-layout>
    ...
    <div>
        <section class="container-fluid p-0 m-0"
            style="background-image: url('{{ $styleHasColour->image_path ? asset('imgs/styles/' . $styleHasColour->image_path) : asset('images/order-component.jpg') }}'); background-position: center; background-repeat: no-repeat; background-size: cover; height: 50vh;">
        </section>
    </div>
