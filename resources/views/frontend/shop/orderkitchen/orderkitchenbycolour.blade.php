<x-guest-layout>
    ...
    <div>
        <section class="container-fluid p-0 m-0"
            style="background-image: url('{{ $style->image_path ? asset('uploads/styles/' . $style->image_path) : asset('images/order-component.jpg') }}'); background-position: center; background-repeat: no-repeat; background-size: cover; height: 50vh;">
        </section>
    </div>
