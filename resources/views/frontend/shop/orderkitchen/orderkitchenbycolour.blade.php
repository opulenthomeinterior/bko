                            ...
                            <div class="tab-pane fade show active" id="baseCabinet-tab" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 order-sm-1 order-xs-1">
                                        @php 
                                            $parentSubCategories = \App\Models\Product::where('parent_category_id', $baseCabinetData->parent_category_id)->where('style_id', $baseCabinetData->style_id)->where('colour_id', $baseCabinetData->colour_id)->where('assembly_id', $baseCabinetData->assembly_id)->groupBy('parent_sub_category')->orderBy('id', 'desc')->get();
                                        @endphp
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 border border-default">
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8 col-sm-12 p-0 text-center">
                                                                    <p class="category-value fw-semibold py-1 mb-2 text-dark">
                                                                        <small>{{ $internalsData->colour->trade_colour ? $internalsData->colour->trade_colour : $internalsData->colour->name }}</small>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            @endif
                                    ...
                                    @if ($edgings->count() > 0)
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 order-sm-1 order-xs-1">
                                            ...
                                            @foreach ($parentSubCategories as $parentSubCategory)
                                                ...
                                                @endif
                                            @endforeach
                                            <label for="" class="fw-bold d-flex justify-content-between"><span>ALL EDGINGS</span><span><a href="@if(!empty($edgingData->style) && !empty($edgingData->assembly) && !empty($edgingData->colour)){{route('viewallorderkitchenbycolour', ['style' => $edgingData->style?->slug , 'assembly' => $edgingData->assembly?->slug, 'colour' => $edgingData->colour?->slug])}}@else#@endif">View All</a></span></label>
