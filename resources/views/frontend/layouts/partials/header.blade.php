@section('styles')
@endsection
<header class="ltn__header-area ltn__header-5 ltn__header-transparent--- gradient-color-4--- section-bg-1">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="mailto:admin@bkonline.uk"><i class="icon-mail"></i>admin@bkonline.uk</a></li>
                            <li><a href="#"><i class="icon-call"></i>020 805 05605</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
                    ...
                    <div class="site-logo-wrap">
                        ...
                        <div class="get-support clearfix d-none">
                            ...
                            <div class="get-support-info">
                                <h6>Get Support</h6>
                                <h4><a href="tel:020 805 05605">020 805 05605</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <nav>
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    <li><a href="#kitchens-section">Kitchens</a></li>
