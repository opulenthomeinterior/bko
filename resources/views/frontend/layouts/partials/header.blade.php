            ...
            <div class="row">
                <div class="col">
                    <div class="site-logo-wrap">
                        <div class="site-logo">
                            <a href="index.html"><img src="{{ asset('assets/img/icons/logoBko.png') }}" alt="Logo"></a>
                        </div>
                                ...
                                <ul>
                                    <li class="menu-icon"><a href="#">Home</a>
                                        <ul class="sub-menu menu-pages-img-show">
                                            <li>
                                                ...
                                                <img src="{{ asset('assets/img/home-demos/home-1.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-2.html">Home Style 02</a>
                                                <img src="{{ asset('assets/img/home-demos/home-2.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-3.html">Home Style 03</a>
                                                <img src="{{ asset('assets/img/home-demos/home-3.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-4.html">Home Style 04</a>
                                                <img src="{{ asset('assets/img/home-demos/home-4.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-5.html">Home Style 05 <span class="menu-item-badge">video</span></a>
                                                <img src="{{ asset('assets/img/home-demos/home-5.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-6.html">Home Style 06</a>
                                                <img src="{{ asset('assets/img/home-demos/home-6.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-7.html">Home Style 07</a>
                                                <img src="{{ asset('assets/img/home-demos/home-7.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-8.html">Home Style 08</a>
                                                <img src="{{ asset('assets/img/home-demos/home-8.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-9.html">Home Style 09</a>
                                                <img src="{{ asset('assets/img/home-demos/home-9.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-10.html">Home Style 10 <span class="menu-item-badge">Map</span></a>
                                                <img src="{{ asset('assets/img/home-demos/home-10.jpg') }}" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-11.html">Home Style 11</a>
                                                <img src="{{ asset('assets/img/home-demos/home-11.jpg') }}" alt="#">
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-icon"><a href="#">Pages</a>
                                        <ul class="mega-menu">
                                            ...
                                            <li><a href="shop.html"><img src="{{ asset('assets/img/banner/menu-banner-1.jpg') }}" alt="#"></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="contact.html">Contact</a></li>
