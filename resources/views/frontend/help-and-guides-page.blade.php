        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <h4 class="text-dark pt-1">
                    At Kitchen Kit we want to make ordering a trade kitchen as easy as possible. From offering a FREE
        ...
        <div class="row py-3">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-4">
                <div class="card component-card card-hover position-relative">
                    ...
                    <div class="card-body about-card-body">
                        <div class="about-card-content">
                            <h4 class="text-uppercase fs-3 fw-bold text-dark">Kitchen Kit Faqs</h4>
                            <div class="text-dark">Having been making, packing and distributing kitchens since 1990, we
                                have developed
                                trusted
                                methods to get what it is you need, to where you need it.</div>
