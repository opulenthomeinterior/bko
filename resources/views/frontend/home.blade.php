                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="about-us-img-wrap about-img-left">
                            <img src="{{ asset('assets/img/others/11.png') }}" alt="About Us Image">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                            <div class="ltn__feature-icon">
                                ...
                                <img src="{{ asset('assets/img/icons/icon-img/21.png') }}" alt="#">
                            </div>
                            <div class="ltn__feature-info">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
                            <div class="ltn__feature-icon">
                                ...
                                <img src="{{ asset('assets/img/icons/icon-img/22.png') }}" alt="#">
                            </div>
                            <div class="ltn__feature-info">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                            <div class="ltn__feature-icon">
                                ...
                                <img src="{{ asset('assets/img/icons/icon-img/23.png') }}" alt="#">
                            </div>
                            <div class="ltn__feature-info">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="ltn__upcoming-project-img">
                                        <img src="{{ asset('assets/img/product-3/3.jpg') }}" alt="#">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__upcoming-project-item">
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="ltn__upcoming-project-img">
                                        <img src="{{ asset('assets/img/product-3/7.jpg') }}" alt="#">
                                    </div>
                                </div>
                                <div class="col-lg-5 section-bg-1">
                                    <div class="ltn__upcoming-project-info ltn__menu-widget">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__neighbour-tab-wrap">
                            <div class="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                                <div class="nav">
                                    <a class="active show" data-bs-toggle="tab" href="#liton_tab_4_1"><img src="{{ asset('assets/img/neighbour/1.jpg') }}" alt="#"></a>
                                    <a data-bs-toggle="tab" href="#liton_tab_4_2" class=""><img src="{{ asset('assets/img/neighbour/2.jpg') }}" alt="#"></a>
                                    <a data-bs-toggle="tab" href="#liton_tab_4_3" class=""><img src="{{ asset('assets/img/neighbour/3.jpg') }}" alt="#"></a>
                                </div>
                            </div>
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="neighbour-apartments-img">
                                                    <img src="{{ asset('assets/img/neighbour/1.jpg') }}" alt="#">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                ...
                                <div class="tab-pane fade" id="liton_tab_4_2">
                                    <div class="ltn__neighbour-tab-content-inner">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="neighbour-apartments-img">
                                                    <img src="{{ asset('assets/img/neighbour/2.jpg') }}" alt="#">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="ltn__search-by-place-item neighbour-apartments-item">
                                ...
                                <div class="tab-pane fade" id="liton_tab_4_3">
                                    <div class="ltn__neighbour-tab-content-inner">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="neighbour-apartments-img">
                                                    <img src="{{ asset('assets/img/neighbour/3.jpg') }}" alt="#">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="ltn__search-by-place-item neighbour-apartments-item">
            ...
            <div class="container">
                ...
                <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/img/blog/5.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                                    <ul>
