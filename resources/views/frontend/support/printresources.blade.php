    ...
    <section class="container-fluid px-lg-5 px-md-3 px-3 py-4">
        <div class="row">
            <form action="{{ route('submit.printresources') }}" method="POST">
                @csrf
                <div class="col-lg-7">
                    <h4 class="text-dark">Complete the form below to order printed copies of the Buy Kitchen Online Product
                        Guide.
                        All fields are
                    ...
                    <div class="row py-3">
                        <div class="col-12">
                            ...
                            <label class="form-check-label" for="consent">
                                By submitting this form, I agree to Buy Kitchen Online's terms and privacy
                                policy
                            </label>
