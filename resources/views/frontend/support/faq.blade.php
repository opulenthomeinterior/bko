<x-guest-layout>
    ...
    <section class="container-fluid px-lg-5 py-4 px-md-3 px-3">
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <h4 class="text-dark">Have a question about Kitchen Kit? Check here to view the ones that we are most
                    commonly asked.</h4>
            </div>
        </div>
    </section>
    ...
    <section class="container-fluid px-lg-5 px-md-3 px-3 py-5">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-dark text-uppercase fw-bolder">General Kitchen Kit FAQ</h3>
