...
<style>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="fs-1 text-dark text-uppercase fw-bolder">
                    Buy Kitchen Online FAQ's
                </h1>
                <h4 class="text-dark">Have a question about Buy Kitchen Online? Check here to view the ones that we are most
                    commonly asked.</h4>
            </div>
        </div>
    </section>
    ...
    <section class="container-fluid px-lg-5 px-md-3 px-3 py-5">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-dark text-uppercase fw-bolder">General Buy Kitchen Online FAQ</h3>
