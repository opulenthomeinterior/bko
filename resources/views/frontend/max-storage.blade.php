...
<body>
    ...
    <section class="container mb-4">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                <img src="https://bkonline.uk/public/imgs/products/TALL-Larder-angled-12501720361557_668aa255bad6b.jpg" class="img-fluid" alt="Modern Kitchen">
            </div>
    ...
    <section class="container mb-4">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                <img src="https://bkonline.uk/public/imgs/products/bridging-unit1739481721_67ae627909ea3.jpg" class="img-fluid" alt="Smart Kitchen">
            </div>
        </div>
    </section>
    ...
    <section class="container mb-4">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                <img src="https://bkonline.uk/public/imgs/products/thick-doors1739481730_67ae6282e5549.jpg" class="img-fluid" alt="Smart Kitchen">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4 d-flex align-items-center">
                <div>
                    ...
                    <ul>
                        ...
                        <li>
                            <span class="font-weight-bold">18 mm+ THICK BACK AND SIDES</span>
                            <ul>
                                <li>
                        ...
                        <li class="font-weight-bold">The height and depth of all the units is customized according to your preferences</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="container mb-4">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12">
                <form method="POST" action="{{ route('contact_us_inquiry') }}" class="border border-dark p-4">
                    @csrf
                    <div>
                        <div class="d-block">
                            <div class="text-center text-dark fw-bold">CALL US NOW FOR FREE SURVEY AND QUOTE</div>
                    ...
                    <h4 id="blinking-text" class="bg-dark text-white fw-bold text-center py-2">
                    ...
                    <div class="mb-3">
                        <label for="" class="text-white bg-dark p-2 text-end fw-bold">Call me at</label>
                    ...
                    <button type="submit" class="btn btn-dark rounded-0 fw-bolder text-uppercase text-white" style="border-radius: 0;">Submit</button>
                </form>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 col-3"></div>
        </div>
