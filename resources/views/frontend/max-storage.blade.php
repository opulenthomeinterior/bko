 ...
 #line3
 {
    ...
    <section class="container mb-4">
        <div class="row">
            ...
            <div class="col-xl-5 p-0 col-lg-6 col-sm-12 col-12 mb-4 d-flex align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-sm-12 col-12 p-0 mb-4">
    ...
    <section class="container mb-4">
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-4">
                <img src="https://bkonline.uk/public/imgs/products/bridging-unit1739481721_67ae627909ea3.jpg" class="img-fluid" alt="Smart Kitchen" style="width:400px; height:420px; box-shadow: -22px 20px 0px 0px rgba(42, 97, 97,1);">
            </div>
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 mb-4 d-flex align-items-center">
