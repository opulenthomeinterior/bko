...
<head>
  ...
  />
    ...
    <script>
        ...
        fbq('init', '1450697616287975');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1450697616287975&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
                                        ...
                                        <ul class="dropdown__list">
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 py-2">
                                                        <li style="width: 100%; border-radius: 0px" class="border-bottom border-default">
                                                            <a style="width: 100%;" href="{{ route('ordercomponentbytypename', [$category->slug]) }}" class="dropdown__link">
